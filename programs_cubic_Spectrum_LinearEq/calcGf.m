function [Gf, gp_x, gw, phi_num] = calcGf( mesh,funP,constf,matC,D0,getNoByIxyz_a,dimRho,K,Nbasis,ngp )
        ...
        for ix=0:2
            for iy=0:2
                for iz=0:2
                    ...
                    No=getNoByIxyz_a(ix+1,iy+1,iz+1,Did);
